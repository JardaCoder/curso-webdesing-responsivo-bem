...
(function () {
  ...
  t = (function () {
    ...
    r.prototype.connect = function () {
      ...
      (this.headers = t[0]),
        (this.connectCallback = t[1]),
        (this.errorCallback = t[2]),
        (this.closeEventCallback = t[3]);
      this._active = true;
    ...
    r.prototype._connect = function () {
      ...
      this.ws.onmessage = (function (s) {
        return function (c) {
          ...
          f =
            typeof ArrayBuffer !== "undefined" && c.data instanceof ArrayBuffer
              ? ((a = new Uint8Array(c.data)),
                typeof s.debug === "function" ? s.debug("--- got data length: " + a.length) : void 0,
                r(a))
              : c.data;
          s.serverActivity = t();
          if (f === e.LF) {
